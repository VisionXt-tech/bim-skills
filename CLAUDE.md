...
- `skills/` — skill organizzate per famiglia (pa-appointing, delivery-team, cde-acdat, ifc-loin-quality, 4d-5d-costs, asset-digital-twin, tools)
...
- Ogni skill e un `SKILL.md` dentro la sua directory
